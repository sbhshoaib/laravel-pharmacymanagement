...
@section('title', 'Add New Pharmaceutical')

@section('content')
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Add New Pharmaceutical</h1>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form action="{{ route('pharmaceuticals.store') }}" method="POST">
                @csrf
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary px-5">
                        <i class="fas fa-save me-2"></i> Save Pharmaceutical
                    </button>
